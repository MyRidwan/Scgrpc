...
wget -q -O /usr/local/bin/websocket https://raw.githubusercontent.com/myridwan/scgrpc/ipuk/websocket/websocket.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/myridwan/scgrpc/ipuk/websocket/ws-ovpn.py
...
wget -q -O /usr/local/bin/ws-stunnel https://raw.githubusercontent.com/myridwan/scgrpc/ipuk/websocket/ws-stunnel
